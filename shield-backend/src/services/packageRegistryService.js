...
function canonicalizeNeuralVPackage(packageDef) {
    ...
    const windowsVariantRecord = {
        ...
        metadata: {
            ...
            cliHostBinaryName: String(windowsMetadata.cliHostBinaryName || 'neuralv-host.exe').trim(),
            ...
            cliHostRelativePath: String(windowsMetadata.cliHostRelativePath || 'libs/neuralv-host.exe').trim(),
